GRADE_MAP = {
    "Intern (Стажер)": [
        "стажер", "intern", "без опыта", "обучение", "студент", 
        "выпускник", "под руководством", "начало карьеры", "junior-", 
        "возможность обучиться"
    ],
    "Junior": [
        "junior", "джуниор", "младший", "1 год", "опыт от года", 
        "базовые знания", "понимание основ", "участие в разработке", 
        "сопровождение", "правка багов"
    ],
    "Middle": [
        "middle", "мидл", "опыт от 2", "опыт от 3", "самостоятельно", 
        "проектирование", "создание сервисов", "уверенное владение", 
        "оптимизация", "рефакторинг", "2-3 года"
    ],
    "Senior": [
        "senior", "сеньор", "старший", "опыт от 5", "архитектура", 
        "highload", "наставничество", "mentoring", "стратегия", 
        "эксперт", "ответственность за проект", "экспертиза", "ведущий"
    ],
    "Lead": [
        "lead", "лид", "тимлид", "team lead", "tech lead", "управление командой", 
        "найм", "формирование процессов", "roadmap", "бэклог"
    ]
}
...
SKILL_MAP = {
    ...
    "Frameworks": [
        ...
        "celery", "pydantic", "sqlalchemy", "asyncio", "centrifuge",
    ...
    "Network_Tools": [
        "tcpdump", "wireshark", "iperf", "ping", "traceroute", "ixia", "spirent", "trex", "keysight", "диагностика", "трафик-генератор"    
    ],
    "Network_Simulation": [
        "virl", "gns3", "eve-ng", "cisco pt", "packet tracer", "simulator"
    ],
    "Hardware_Vendors": [
        "cisco", "juniper", "huawei", "ericsson", "extreme", "yadro", "keysight", "spirent"
    ],
    ...
    "Network_Protocols": [
        "bgp", "ospf", "vxlan", "vrrp", "lacp", "mc-lag", "vpn", "ip-сети", "маршрутизация", "ethernet", "sdn", "open vswitch", "tcp/ip"
    ],
    ...
    "Tools": [
        "pyright", "webdriver", "excel", "git", "github", "gitlab", "bitbucket", "devtools", 
        "jira", "confluence",
        "postman", "insomnia",
        "swagger", "openapi",
    ...
    "voice assistant", "голосовой ассистент", "прогнозирование", "планирование"
    ]   
}
