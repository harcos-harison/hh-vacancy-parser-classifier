...
Ниже представлен файл, который был сгенерирован программой после завершения полного цикла парсинга и анализа 1000 вакансий по запросу "Python" в Москве. 

Вы можете использовать его для ознакомления со структурой данных или для тестирования модуля аналитики без запуска парсера:

📥 **[Скачать результат работы (1000 вакансий Москва)](./тест%201000%20вакансий%20Москва.xlsx)**

*Файл содержит: очищенные описания, лемматизированный текст, извлеченный стек технологий и автоматическую классификацию ролей.*
